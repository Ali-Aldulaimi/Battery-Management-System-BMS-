			...
			if (CRC2 == 0) {
				...
				if (check) {
					...
					Int_temp = Internal_Temp_Read();
							...
							internal_sensor_high_byte = (Int_temp >> 8) | internal_sensor_high_byte;
							internal_sensor_low_byte = Int_temp | internal_sensor_low_byte;

							LM35_temp = LM35_Temp_read();
							delay_Ms(200);

							external_sensor_high_byte =  (LM35_temp>>8)| external_sensor_high_byte;
							external_sensor_low_byte = LM35_temp |external_sensor_high_byte;
